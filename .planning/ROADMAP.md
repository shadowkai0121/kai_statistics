...
- [x] 01-03: Add test scaffolding, smoke tests, GitHub Actions-based PyPI publishing, and contributor-oriented extension/install guidance.
...
|-------|----------------|--------|-----------|
| 1. Library Infrastructure | 3/3 | Awaiting human verification |  |
